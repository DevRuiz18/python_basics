...
num = int(input("Informe de qual numero deseja montar a tabela: "))
start = int(input("Informe em qual numero deseja começar: "))
count = 0
while (count != 1):
    end = int(input("Informe em qual numero deseja terminar: "))
    if(end > start):
        count += 1
    else:
        print("Começo maior que o final")

print("Vou montar a tabuada de {}} começando em {} e terminando em {}:".format(num, start, end))
